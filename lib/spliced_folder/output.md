...
class VideoDownloaderNotifier extends StateNotifier<VideoDownloaderState> {
  ...
  Future<void> downloadTwitterVideo(String url) async {
    ...
    try {
      ...
      final downloadButton = document.getElementsByClassName('origin-top-right')[0];
...
final videoDownloaderProvider = StateNotifierProvider<VideoDownloaderNotifier, VideoDownloaderState>(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            // ダウンロードボタン
            ElevatedButton.icon(
              onPressed: videoDownloaderState.downloadStatus == DownloadStatus.loading
                  ? null
                  : () async {
                      ...
                      if (videoUrl.contains('x.com')) {
                        await videoDownloaderNotifier.downloadTwitterVideo(videoUrl);
                      } else {
              ...
              Expanded(
                child: Card(
                  child: Padding(
                    ...
                    child: videoPlayerController.value?.value.isInitialized == true
                        ? AspectRatio(
